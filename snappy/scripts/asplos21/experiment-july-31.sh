...
#block_size_list=(2048 4096 8192 16384 32768 65536 131072 262144 524288 1048576 2097152 4194304 8388608)
block_size_list=(16777216)

for block_size in "${block_size_list[@]}"
do
   for tasklets in {1..24}
   do
    # sudo python run_tests.py -t 1 -f dickens8MB -r 2304 2304 -i 64 -b ${block_size} 
    # sudo python run_tests.py -t 1 -f dickens16MB -r 2304 2304 -i 64 -b ${block_size}
    # sudo python run_tests.py -t 1 -f dickens32MB -r 2304 2304 -i 64 -b ${block_size}
    # sudo python run_tests.py -t 1 -f dickens64MB -r 2304 2304 -i 64 -b ${block_size}
    # sudo python run_tests.py -t 1 -f dickens128MB -r 2304 2304 -i 64 -b ${block_size}
    # sudo python run_tests.py -t 1 -f dickens256MB -r 2304 2304 -i 64 -b ${block_size}
    # sudo python run_tests.py -t 1 -f dickens512MB -r 2304 2304 -i 64 -b ${block_size}
